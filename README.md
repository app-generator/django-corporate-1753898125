...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-corporate-1753898125) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-corporate-1753898125.git
$ cd django-corporate-1753898125
```
